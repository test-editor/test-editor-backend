...
//	static val initialized = ensureServiceLocatorPopulated
	...
	private def createClientRule() {
		dropwizardClientRule = new DropwizardAppRule(TestEditorApplication,			ResourceHelpers.resourceFilePath('test-config.yml'),
