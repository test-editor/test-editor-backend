...
exec xvfb-run --server-args="-screen 0 1920x1080x16" /usr/bin/bash -c "/opt/testeditor/bin/org.testeditor.web.backend.persistence server /opt/testeditor/config.yml"
